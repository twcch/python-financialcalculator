...
class DiscountCalculatorServiceImpl(DiscountCalculatorService):
    ...
    def calculate_monthly_interest_rate_for_discount(self):
        annual_interest_rate_for_discount = self.__claim_benefit_params.get_annual_interest_rate_for_discount()
    ...
    def calculate_monthly_discount_rate(self):
        annual_interest_rate_for_discount = self.__claim_benefit_params.get_annual_interest_rate_for_discount()
        monthly_discount_rate = round(decimal.Decimal((1 + annual_interest_rate_for_discount) ** (-1 / 12)), 9)
    ...
    def calculate_discount_amount(self):
        ...
        monthly_interest_rate_for_discount = self.calculate_monthly_interest_rate_for_discount()
        monthly_discount_rate = self.calculate_monthly_discount_rate()

        discount_amount = round(decimal.Decimal(payment_amount * (1 - monthly_discount_rate ** times) / (
                monthly_interest_rate_for_discount * monthly_discount_rate)), 0)
